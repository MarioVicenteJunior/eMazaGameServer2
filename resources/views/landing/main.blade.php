                    ...
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">
                                Be, vinod ao servidor de eMazaGame
                            </h1>
	                        <p class="hero-paragraph">
                                Este servidor processa todas as informacoes utilizadas no eMazaGame. Somente usuarios permitidos tem acesso a area restrita deste servidor.
                            </p>
	                        <div class="hero-cta">
                            ...
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <p class="text-sm mb-0">
                                        Atravez do eMazaGame voce pode aprender tudo o que precisa. Aprenda desde linguas,
                                         matematica, tecnologias e outras ciencias exactas e puras de forma divertida 
                                        usando este aplicativo. Baixe agora!
                                    </p>
                                </div>
                            </div>
							<div class="feature text-center is-revealing">
                ...
                <div class="container-sm">
                    <div class="pricing-inner section-inner">
                        <div class="pricing-header text-center">
                            <h2 class="section-title mt-0">Aplicativo com precos acessiveis</h2>
						...
						<div class="pricing-tables-wrap">
                            ...
                            <div class="pricing-table">
                                <div class="pricing-table-inner is-revealing">
                                    <div class="pricing-table-main">
                                        <div class="pricing-table-header pb-24">
                                            <div class="pricing-table-price"><span class="pricing-table-price-currency h2">MZN</span><span class="pricing-table-price-amount h1">129</span><span class="text-xs">/mes</span></div>
                                        </div>
